...
<body class="bg-[#fcfcfd] text-gray-800 font-sans antialiased selection:bg-primary selection:text-white flex flex-col min-h-screen">
    ...
    <nav class="bg-white/80 backdrop-blur-md sticky top-0 z-50 border-b border-gray-100 shadow-[0_4px_30px_rgba(0,0,0,0.02)]">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-24 items-center">
                ...
                <div class="hidden md:flex items-center gap-8">
                    <a href="../index.php" class="text-sm font-medium text-gray-500 hover:text-gray-900 transition-colors py-2 px-1" <?= $siswa; ?>>Beranda</a>
                    <a href="./siswa.php" class="text-sm font-medium text-gray-500 hover:text-gray-900 transition-colors py-2 px-1" <?= $siswa; ?>>Siswa</a>
                    <a href="./guru.php" class="text-sm font-medium text-gray-500 hover:text-gray-900 transition-colors py-2 px-1" <?= $guru; ?> <?= $osis; ?> <?= $siswa; ?>>Guru</a>
        ...
        <div id="mobileMenu" class="hidden md:hidden bg-white border-t border-gray-100 px-4 pt-4 pb-6 space-y-2 shadow-xl">
            <a href="../index.php" class="block px-4 py-3 rounded-xl text-gray-600 hover:bg-gray-50 font-medium" <?= $siswa; ?>>Beranda</a>
            <a href="./siswa.php" class="block px-4 py-3 rounded-xl text-gray-600 hover:bg-gray-50 font-medium" <?= $siswa; ?>>Siswa</a>
            <a href="./guru.php" class="block px-4 py-3 rounded-xl text-gray-600 hover:bg-gray-50 font-medium" <?= $guru; ?> <?= $osis; ?> <?= $siswa; ?>>Guru</a>
                ...
                <div class="bg-gradient-to-r from-gray-50 to-white px-8 py-10 border-b border-gray-100 relative overflow-hidden">
                    ...
                    <div class="flex flex-col md:flex-row md:items-center justify-between gap-6">
                        <div>
                            ...
                            <h2 class="font-serif text-3xl font-bold text-gray-900 mb-2">Ketentuan</h2>
                            <p class="text-gray-500">Daftar ketentuan prestasi dan pelanggaran tata tertib sekolah.</p>
                        </div>
                        
                        <div class="flex flex-col sm:flex-row gap-3">
                            <button onclick="openModal('upload_excel')" class="inline-flex items-center justify-center gap-2 px-6 py-3 rounded-xl bg-emerald-600 text-white font-bold transition-all hover:bg-emerald-700 focus:ring-2 focus:ring-emerald-600 focus:ring-offset-2" <?= $osis; ?><?= $siswa; ?>>
                                <i class="bi bi-file-earmark-excel-fill"></i> Upload Excel (Pelanggaran)
                            </button>
                            <button onclick="openModal('tambah_prestasi')" class="inline-flex items-center justify-center gap-2 px-6 py-3 rounded-xl bg-blue-600 text-white font-bold transition-all hover:bg-blue-700 focus:ring-2 focus:ring-blue-600 focus:ring-offset-2" <?= $osis; ?><?= $siswa; ?>>
                                <i class="bi bi-award-fill"></i> Tambah Prestasi
                            </button>
                            <button onclick="openModal('tambah_plgr')" class="inline-flex items-center justify-center gap-2 px-6 py-3 rounded-xl bg-red-600 text-white font-bold transition-all hover:bg-red-700 focus:ring-2 focus:ring-red-600 focus:ring-offset-2" <?= $osis; ?><?= $siswa; ?>>
                                <i class="bi bi-exclamation-triangle-fill"></i> Tambah Pelanggaran
                            </button>
                        </div>
                    </div>
                </div>
                                    ...
                                    <table class="w-full text-left border-collapse whitespace-nowrap">
                                        <thead>
                                            <tr class="bg-gray-50/80 text-gray-600 text-sm border-b border-gray-100">
                                                <th class="py-3 px-4 font-bold tracking-wider uppercase text-center w-16">No</th>
                                                <th class="py-3 px-4 font-bold tracking-wider uppercase">Prestasi</th>
                                                <th class="py-3 px-4 font-bold tracking-wider uppercase text-center">Poin</th>
                                                <th class="py-3 px-4 font-bold tracking-wider uppercase text-center w-24" <?= $osis; ?><?= $siswa; ?>>Aksi</th>
                                            </tr>
                                        </thead>
                                        <tbody class="divide-y divide-gray-100 bg-white">
                                            ...
                                            <?php foreach ($ktnprestasi as $prestasi) : ?>
                                                <tr class="hover:bg-gray-50/50 transition-colors">
                                                    <td class="py-3 px-4 text-sm text-gray-500 text-center font-medium"><?= $nomor++; ?></td>
                                                    <td class="py-3 px-4 text-sm text-gray-700 font-medium"><?= ucfirst($prestasi["det_prestasi"]); ?></td>
                                                    <td class="py-3 px-4 text-center">
                                                        <span class="inline-flex items-center justify-center px-2.5 py-0.5 rounded-full bg-blue-50 text-blue-700 text-xs font-bold ring-1 ring-inset ring-blue-600/20">
                                                            +<?= $prestasi["poin_prestasi"]; ?>
                                                        </span>
                                                    </td>
                                                    <td class="py-3 px-4 text-center relative dropdown-container" <?= $osis; ?><?= $siswa; ?>>
                                ...
                                <div class="overflow-x-auto custom-scrollbar border border-gray-100 rounded-xl">
                                    <table class="w-full text-left border-collapse whitespace-nowrap">
                                        <thead>
                                            <tr class="bg-gray-50/80 text-gray-600 text-sm border-b border-gray-100">
                                                <th class="py-3 px-4 font-bold tracking-wider uppercase text-center w-16">No</th>
                                                <th class="py-3 px-4 font-bold tracking-wider uppercase">Jenis</th>
                                                <th class="py-3 px-4 font-bold tracking-wider uppercase">Pelanggaran</th>
                                                <th class="py-3 px-4 font-bold tracking-wider uppercase text-center">Poin</th>
                                                <th class="py-3 px-4 font-bold tracking-wider uppercase text-center w-24" <?= $osis; ?><?= $siswa; ?>>Aksi</th>
                                            </tr>
                                        </thead>
                                        <tbody class="divide-y divide-gray-100 bg-white">
                                            ...
                                            <?php foreach ($data_kntplgr as $plgr) : ?>
                                                <tr class="hover:bg-gray-50/50 transition-colors">
                                                    <td class="py-3 px-4 text-sm text-gray-500 text-center font-medium"><?= $nomor++; ?></td>
                                                    <td class="py-3 px-4 text-sm text-gray-900 font-bold"><?= ucwords($plgr["jenis_pelanggaran"]); ?></td>
                                                    <td class="py-3 px-4 text-sm text-gray-700"><?= ucfirst($plgr["det_pelanggaran"]); ?></td>
                                                    <td class="py-3 px-4 text-center">
                                                        <span class="inline-flex items-center justify-center px-2.5 py-0.5 rounded-full bg-red-50 text-red-700 text-xs font-bold ring-1 ring-inset ring-red-600/10">
                ...
                <div class="relative transform overflow-hidden rounded-3xl bg-white text-left shadow-2xl transition-all sm:my-8 sm:w-full sm:max-w-md border border-gray-100">
                    <div class="bg-white px-6 pb-6 pt-8">
                        <div class="flex items-center justify-between border-b border-gray-100 pb-4 mb-4">
                            <h3 class="text-xl font-serif font-bold text-gray-900" id="modal-title">Tambah Prestasi</h3>
                            <button type="button" onclick="closeModal('tambah_prestasi')" class="text-gray-400 hover:text-gray-500 focus:outline-none">
                                <i class="bi bi-x-lg text-xl"></i>
                            </button>
                        </div>
                        <div class="mt-4">
                            <form action="" method="post" id="form_tambah_prestasi" class="space-y-4">
                                <div>
                                    <label for="det_prestasi" class="block text-sm font-semibold text-gray-700 mb-1.5">Detail Prestasi</label>
                                    <input type="text" class="w-full rounded-xl border-gray-200 shadow-sm focus:border-primary focus:ring-primary text-sm px-4 py-2.5 border outline-none transition-all" id="det_prestasi" name="det_prestasi" required placeholder="Juara 17-an..." autocomplete="off">
                                </div>
                                
                                <div>
                                    <label for="poin_prestasi" class="block text-sm font-semibold text-gray-700 mb-1.5">Poin Prestasi</label>
                                    <input type="number" class="w-full rounded-xl border-gray-200 shadow-sm focus:border-primary focus:ring-primary text-sm px-4 py-2.5 border outline-none transition-all" id="poin_prestasi" name="poin" required placeholder="1 / 2 / ..." autocomplete="off">
                                </div>
                            </form>
                        </div>
                    </div>
                    <div class="bg-gray-50/80 px-6 py-4 sm:flex sm:flex-row-reverse">
                        <button type="submit" form="form_tambah_prestasi" name="tambah_prestasi" class="inline-flex w-full justify-center rounded-xl bg-primary px-6 py-3 text-sm font-bold text-white shadow-sm hover:bg-secondary sm:ml-3 sm:w-auto transition-colors">Tambah</button>
    ...
    <div id="tambah_plgr" class="hidden fixed inset-0 z-[100]" aria-labelledby="modal-title" role="dialog" aria-modal="true">
        <div class="fixed inset-0 bg-gray-900/40 backdrop-blur-sm transition-opacity" onclick="closeModal('tambah_plgr')"></div>
        <div class="fixed inset-0 z-10 overflow-y-auto">
            <div class="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
                <div class="relative transform overflow-hidden rounded-3xl bg-white text-left shadow-2xl transition-all sm:my-8 sm:w-full sm:max-w-md border border-gray-100">
                    <div class="bg-white px-6 pb-6 pt-8">
                        <div class="flex items-center justify-between border-b border-gray-100 pb-4 mb-4">
                            <h3 class="text-xl font-serif font-bold text-gray-900" id="modal-title">Tambah Pelanggaran</h3>
                            <button type="button" onclick="closeModal('tambah_plgr')" class="text-gray-400 hover:text-gray-500 focus:outline-none">
                                <i class="bi bi-x-lg text-xl"></i>
                            </button>
                        </div>
                        <div class="mt-4">
                            <form action="" method="post" id="form_tambah_plgr" class="space-y-4">
                                <div>
                                    <label for="jenis_plgr" class="block text-sm font-semibold text-gray-700 mb-1.5">Jenis Pelanggaran</label>
                                    <input type="text" class="w-full rounded-xl border-gray-200 shadow-sm focus:border-primary focus:ring-primary text-sm px-4 py-2.5 border outline-none transition-all" id="jenis_plgr" placeholder="kedisiplinan, kerapian..." name="jenis_plgr" required autocomplete="off" autofocus>
                                </div>
                                
                                <div>
                                    <label for="det_plgr" class="block text-sm font-semibold text-gray-700 mb-1.5">Detail Pelanggaran</label>
                                    <input type="text" class="w-full rounded-xl border-gray-200 shadow-sm focus:border-primary focus:ring-primary text-sm px-4 py-2.5 border outline-none transition-all" id="det_plgr" name="det_plgr" required placeholder="datang terlambat..." autocomplete="off">
                                </div>
                                
                                <div>
                                    <label for="poin_plgr" class="block text-sm font-semibold text-gray-700 mb-1.5">Poin Pelanggaran</label>
                                    <input type="number" class="w-full rounded-xl border-gray-200 shadow-sm focus:border-primary focus:ring-primary text-sm px-4 py-2.5 border outline-none transition-all" id="poin_plgr" name="poin" required placeholder="1 / 2 / ..." autocomplete="off">
                                </div>
                            </form>
                        </div>
                    </div>
                    <div class="bg-gray-50/80 px-6 py-4 sm:flex sm:flex-row-reverse">
                        <button type="submit" form="form_tambah_plgr" name="tambah_plgr" class="inline-flex w-full justify-center rounded-xl bg-red-600 px-6 py-3 text-sm font-bold text-white shadow-sm hover:bg-red-700 sm:ml-3 sm:w-auto transition-colors">Tambah</button>
                        <button type="button" onclick="closeModal('tambah_plgr')" class="mt-3 inline-flex w-full justify-center rounded-xl bg-white px-6 py-3 text-sm font-bold text-gray-700 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50 sm:mt-0 sm:w-auto transition-colors">Batal</button>
                    </div>
                </div>
            </div>
        </div>
    ...
    <!-- Modal Upload Excel Pelanggaran -->
        ...
        <div class="fixed inset-0 z-10 overflow-y-auto">
            <div class="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
                <div class="relative transform overflow-hidden rounded-3xl bg-white text-left shadow-2xl transition-all sm:my-8 sm:w-full sm:max-w-lg border border-gray-100">
                    <div class="bg-white px-6 pb-6 pt-8">
                        <div class="flex items-center justify-between border-b border-gray-100 pb-4 mb-4">
                            <h3 class="text-xl font-serif font-bold text-gray-900">Upload Ketentuan Pelanggaran (Excel)</h3>
                            <button type="button" onclick="closeModal('upload_excel')" class="text-gray-400 hover:text-gray-500 focus:outline-none">
                                <i class="bi bi-x-lg text-xl"></i>
                            </button>
                        </div>
                        <div class="mt-4">
                            <div class="mb-4 p-4 rounded-xl bg-emerald-50 border border-emerald-100 text-sm text-emerald-800 leading-relaxed">
                                <div class="flex justify-between items-start mb-2">
                                    <strong>Format Kolom Excel (.xlsx):</strong>
                                    <a href="download_template.php?type=pelanggaran" class="inline-flex items-center gap-1.5 px-3 py-1.5 bg-emerald-600 text-white text-xs font-bold rounded-lg hover:bg-emerald-700 transition-colors shadow-sm">
                                        <i class="bi bi-download"></i> Download Template
                                    </a>
                                </div>
                                Baris pertama adalah header/judul kolom (akan otomatis diabaikan sistem).<br><br>
                                <ul class="list-disc list-inside">
                                    <li><strong>Kolom 1:</strong> Jenis Pelanggaran (misal: "ringan", "sedang", "berat")</li>
                                    <li><strong>Kolom 2:</strong> Detail Pelanggaran (Teks deskripsi)</li>
                                    <li><strong>Kolom 3:</strong> Poin (Angka)</li>
                                </ul>
                            </div>
                            <form action="./import_plgr.php" method="post" enctype="multipart/form-data" id="form_upload_excel" class="space-y-4">
                                <div>
                                    <label for="file_excel" class="block text-sm font-semibold text-gray-700 mb-1.5">Pilih File (.xlsx)</label>
                                    <input type="file" class="w-full text-sm text-gray-600 file:mr-4 file:py-2 file:px-4 file:rounded-xl file:border-0 file:text-sm file:font-bold file:bg-emerald-100 file:text-emerald-700 hover:file:bg-emerald-200 cursor-pointer border border-gray-200 rounded-xl transition-colors" id="file_excel" name="file_excel" accept=".xlsx" required>
                                </div>
                            </form>
                        </div>
                    </div>
                    <div class="bg-gray-50/80 px-6 py-4 sm:flex sm:flex-row-reverse">
                        <button type="submit" form="form_upload_excel" name="upload" class="inline-flex w-full justify-center rounded-xl bg-emerald-600 px-6 py-3 text-sm font-bold text-white shadow-sm hover:bg-emerald-700 sm:ml-3 sm:w-auto transition-colors">Upload & Import</button>
    ...
    <script>
        ...
        function toggleDropdown(id) {
            ...
            document.querySelectorAll('[id^="actionMenuPrestasi_"], [id^="actionMenuPlgr_"], #userMenu, #mobileMenu').forEach(el => {
        ...
        window.addEventListener('click', function(e) {
            ...
            if (!e.target.closest('.relative') && !e.target.closest('.dropdown-container') && !e.target.closest('#userMenuContainer')) {
                document.querySelectorAll('[id^="actionMenuPrestasi_"], [id^="actionMenuPlgr_"], #userMenu').forEach(el => {
        ...
        function openModal(id) {
            ...
            document.querySelectorAll('[id^="actionMenu"], #userMenu, #mobileMenu').forEach(el => el.classList.add('hidden'));
        }
