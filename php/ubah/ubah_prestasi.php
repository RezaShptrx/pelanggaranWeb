            ...
            <div class="bg-white rounded-[2rem] shadow-[0_8px_30px_rgba(0,0,0,0.04)] border border-gray-100 overflow-hidden">
                <div class="bg-gradient-to-r from-secondary to-primary px-8 py-6 relative overflow-hidden">
                    <h1 class="font-serif text-2xl font-bold text-white relative z-10 flex items-center gap-3">
                        <i class="bi bi-pencil-square"></i> Ubah Ketentuan Prestasi
                    </h1>
                </div>
                ...
                <div class="p-8">
                    <form action="" method="post" class="space-y-6">
                        ...
                        <!-- Detail Prestasi -->
                        <div>
                            <label for="det_prestasi" class="block text-sm font-bold text-gray-700 mb-2">Detail Prestasi</label>
                            <input type="text" id="det_prestasi" name="det_prestasi" class="w-full rounded-xl border-gray-200 shadow-sm focus:border-primary focus:ring-primary text-sm px-4 py-2.5 border outline-none transition-all" required autocomplete="off" value="<?= $ktnprestasi["det_prestasi"]; ?>" placeholder="Juara Lomba...">
                        </div>
                        
                        <!-- Poin Prestasi -->
                        <div>
                            <label for="poin" class="block text-sm font-bold text-gray-700 mb-2">Poin Prestasi</label>
                            <input type="number" id="poin" name="poin" class="w-full rounded-xl border-gray-200 shadow-sm focus:border-primary focus:ring-primary text-sm px-4 py-2.5 border outline-none transition-all" required autocomplete="off" value="<?= $ktnprestasi["poin_prestasi"]; ?>" placeholder="1 / 2 / ...">
                        </div>
