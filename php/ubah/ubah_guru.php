            ...
            <div class="bg-white rounded-[2rem] shadow-[0_8px_30px_rgba(0,0,0,0.04)] border border-gray-100 overflow-hidden">
                <div class="bg-gradient-to-r from-secondary to-primary px-8 py-6 relative overflow-hidden">
                    <h1 class="font-serif text-2xl font-bold text-white relative z-10 flex items-center gap-3">
                        <i class="bi bi-pencil-square"></i> Ubah Data Guru
                    </h1>
                </div>
                ...
                <div class="p-8">
                    <form action="" method="post" class="space-y-6">
                        ...
                        <!-- NIP / NUPTK -->
                        <div>
                            <label for="nip" class="block text-sm font-bold text-gray-700 mb-2">NIP / NUPTK</label>
                            <input type="number" id="nip" name="nip" class="w-full rounded-xl border-gray-200 shadow-sm focus:border-primary focus:ring-primary text-sm px-4 py-2.5 border outline-none transition-all" required autocomplete="off" autofocus value="<?= $guru["nip"]; ?>" placeholder="18 digit / 16 digit">
                        </div>
                        
                        <!-- Nama Lengkap -->
                        <div>
                            <label for="nama" class="block text-sm font-bold text-gray-700 mb-2">Nama Lengkap</label>
                            <input type="text" id="nama" name="nama" class="w-full rounded-xl border-gray-200 shadow-sm focus:border-primary focus:ring-primary text-sm px-4 py-2.5 border outline-none transition-all" required autocomplete="off" value="<?= $guru["nama_guru"]; ?>" placeholder="Nama lengkap guru">
                        </div>
                        
                        <!-- Email -->
                        <div>
                            <label for="email" class="block text-sm font-bold text-gray-700 mb-2">Email</label>
                            <input type="email" id="email" name="email" class="w-full rounded-xl border-gray-200 shadow-sm focus:border-primary focus:ring-primary text-sm px-4 py-2.5 border outline-none transition-all" required autocomplete="off" value="<?= $guru["email"]; ?>" placeholder="email@gmail.com">
                        </div>
                        
                        <div class="pt-6 border-t border-gray-100 flex flex-col sm:flex-row gap-3 justify-end">
                            <a href="../guru.php" class="inline-flex justify-center items-center px-6 py-2.5 rounded-xl bg-white border border-gray-200 text-gray-700 font-bold hover:bg-gray-50 transition-colors focus:ring-2 focus:ring-gray-200 focus:ring-offset-2">Batal</a>
